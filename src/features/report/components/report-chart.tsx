...
const PERIOD_LABELS = {
  MONTHLY: "Daily sales for the current month",
  QUARTERLY: "Weekly sales for the current quarter",
  YEARLY: "Monthly sales for the current year",
};

const CHART_COLORS = {
  "Total Sales": "hsl(var(--chart-1))",
  "Order Count": "hsl(var(--chart-2))",
  "Average Order Value": "hsl(var(--chart-3))",
  "Customer Count": "hsl(var(--chart-4))",
};
...
export const ReportChart = () => {
  ...
  const [chartData, { isPending }] =
    trpc.report.getSalesChartData.useSuspenseQuery({
      datePeriod,
    });
        ...
        <div className="flex w-full items-start gap-2 text-sm">
          <div className="grid gap-2">
            <div className="flex items-center gap-2 font-medium leading-none">
              {selectedDataset?.name || "Sales"} Overview{" "}
